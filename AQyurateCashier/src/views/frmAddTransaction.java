...
public class frmAddTransaction extends javax.swing.JFrame {
        ...
        pnlItemsLayout.setHorizontalGroup(
            ...
            .addGroup(pnlItemsLayout.createSequentialGroup()
                ...
                .addGroup(pnlItemsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlItemsLayout.createSequentialGroup()
                        .addComponent(btnEditQty, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        String timeNow = time.format(formatter).toString();
        ...
        if (tm.getRowCount() != 0)
        {
            ...
            if (money.equals("0") || money.equals(""))
            {
                MessageError me = new MessageError(this, true);
                me.jLabel2.setText("Gagal");
                me.jLabel3.setText("Masukkan input yang benar!");
                me.showAlert();
            } else if (Integer.valueOf(money) < totalTrans) {
                MessageError me = new MessageError(this, true);
                me.jLabel2.setText("Gagal");
                me.jLabel3.setText("Nominal lebih kecil dari total transaksi!");
                me.showAlert();
            } else {
                Integer change = Integer.valueOf(money) - totalTrans;
                for (int x = 0; x < tm.getRowCount(); x++)
                {
                    try
                    {
                        Transaction trans = new Transaction(
                                tbList.getValueAt(x, 0).toString(), 
                                Integer.valueOf(tm.getValueAt(x, 2).toString()), 
                                Integer.valueOf(tm.getValueAt(x, 3).toString()),
                        ...
                        if (tc.addTrans(trans))
                        {
                            MessageSuccess me = new MessageSuccess(this,true);
                            me.jLabel2.setText("Sukses");
                            me.jLabel3.setText("Berhasil Menambahkan Transaksi! Kembalian ["+ change +"]");
                            me.showAlert();
